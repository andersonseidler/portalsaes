            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label">Nome</label>
                            <input type="text" name="name" value="{{ $user->name ?? old('name') }}" class="form-control" placeholder=" "  />
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-1">
                        <div class="mb-3">
                            <label">CEP</label>
                            <input type="text" name="cep" onblur="pesquisacep(this.value);" value="{{ $user->cep ?? old('cep') }}" id="cep" class="form-control" placeholder=" " required />
                        </div><!--  onkeyup="handleZipCode(event)" -->
                    </div>
                    <div class="col-lg-3">
                        <div class="mb-3">
                    ...
                    <div class="col-lg-2">
                        <div class="mb-3">
                            ...
                            <input type="text" name="complemento" value="{{ $user->complemento ?? old('complemento') }}" id="complemento" class="form-control" placeholder=" " />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="confirmar_senha" class="form-control" placeholder=" " required />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 text-end">
                        <a href="{{ url()->previous() }}"><button type="button" class="btn btn-secondary btn-sm"><i class="fa-solid fa-arrow-left"></i> Voltar</button></a>
                    <button type="button" onclick="form.reset();" class="btn btn-warning btn-sm"><i class="fa-solid fa-eraser"></i> Limpar</button>
                    <button type="submit" class="btn btn-success btn-sm"><i class="fa-solid fa-floppy-disk"></i> Cadastrar</button>
                    </div>
                </div>
            </div>
        </div>
